    ...
    <>
      ...
      <div className="flex flex-col p-2">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          />
          <button
            className="bg-gradient-to-l from-primary-400 via-secondary-400 to-primary-500 hover:from-primary-500 hover:via-secondary-500 hover:to-primary-600 text-white text-sm font-semibold py-2 px-4 rounded-md flex"
            onClick={handleClick}
          >
            Select File
          </button>
