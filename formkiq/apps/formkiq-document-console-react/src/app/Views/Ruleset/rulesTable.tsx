...
function RulesTable({
  ...
  return (
    ...
    >
      <thead
        className="sticky top-0 bg-neutral-100 z-10 pt-2 border-b border-t font-bold text-transparent text-left border-neutral-300">
      <tr>
        <th
          className="w-1/5 max-w-52 border-b border-t border-neutral-300  p-4 pl-8 py-3 bg-clip-text bg-gradient-to-l from-primary-500 via-secondary-500 to-primary-600">
          Description
        </th>
        <th
          className=" border-b border-t border-neutral-300 p-4 py-3 bg-clip-text bg-gradient-to-l from-primary-500 via-secondary-500 to-primary-600">
          Priority
        </th>
        <th
          className=" border-b border-t border-neutral-300 p-4 py-3 bg-clip-text bg-gradient-to-l from-primary-500 via-secondary-500 to-primary-600">
        ...
        <th
          className="w-1/2 border-b border-t border-neutral-300 p-4 py-3 bg-clip-text bg-gradient-to-l from-primary-500 via-secondary-500 to-primary-600">
          Conditions
        </th>
        <th
          className=" w-1/5 border-b border-t border-neutral-300 p-4 py-3 bg-clip-text bg-gradient-to-l from-primary-500 via-secondary-500 to-primary-600">
          Actions
        </th>
      </tr>
      </thead>
      ...
      {rules && rules.length > 0 ? (
        <>
          {rules.map((rule: Rule, index: number) => {
            return (
              <tr key={'rule_' + index} className="text-neutral-900 align-top">
                ...
                <td className="border-b border-neutral-300 p-4 pr-8 ">
                  <div className="flex items-center">
                    ...
                    <a
                      ...
                      className="w-4 h-auto font-bold mr-3 cursor-pointer hover:text-primary-500 my-[3px] whitespace-nowrap"
                    >
                      Open in Editor
                    </a>
                  </div>
