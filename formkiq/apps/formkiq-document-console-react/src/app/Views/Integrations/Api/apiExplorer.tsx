...
export function ApiExplorer() {
  ...
  const [documentAntivirusExpanded, setDocumentAntivirusExpanded] =
    useState(false);
  ...
  const [documentFulltextSearchExpanded, setDocumentFulltextSearchExpanded] =
    useState(false);
  ...
  const [documentVersionsExpanded, setDocumentVersionsExpanded] =
    useState(false);
      ...
      <div className="p-4 flex w-full flex-col lg:flex-row max-w-screen-xl">
        <div className="w-full inline-block">
          ...
          {documentsExpanded && (
            <div className="ml-2 mb-4 flex flex-cols">
              ...
              <div className="grow">
                ...
                <ApiItem
                  apiItem={deleteDocumentApiItem}
                  sites={sites}
                ></ApiItem>
                <ApiItem
                  apiItem={getDocumentContentApiItem}
                  sites={sites}
                ></ApiItem>
                <ApiItem
                  apiItem={getDocumentUrlApiItem}
                  sites={sites}
                ></ApiItem>
                <div
                ...
                {documentOcrExpanded && (
                  <div className="ml-2 flex flex-cols">
                    ...
                    <div className="grow">
                      <ApiItem
                        apiItem={getDocumentOcrApiItem}
                        sites={sites}
                      ></ApiItem>
                      <ApiItem
                        apiItem={postDocumentOcrApiItem}
                        sites={sites}
                      ></ApiItem>
                      <ApiItem
                        apiItem={putDocumentOcrApiItem}
                        sites={sites}
                      ></ApiItem>
                      <ApiItem
                ...
                {documentFulltextSearchExpanded && (
                  <div className="ml-2 flex flex-cols">
                    ...
                    <div className="grow">
                      <ApiItem
                        apiItem={documentFulltextSearch}
                        sites={sites}
                      ></ApiItem>
                      <ApiItem
                        apiItem={fulltextQueryApiItem}
                        sites={sites}
                      ></ApiItem>
                      <ApiItem
                ...
                {documentTagsExpanded && (
                  <div className="ml-2 flex flex-cols">
                    ...
                    <div className="grow">
                      <ApiItem
                        apiItem={getDocumentTagsApiItem}
                        sites={sites}
                      ></ApiItem>
                      <ApiItem
                ...
                {documentFoldersExpanded && (
                  <div className="ml-2 flex flex-cols">
                    ...
                    <div className="grow">
                      <ApiItem
                        apiItem={moveDocumentApiItem}
                        sites={sites}
                      ></ApiItem>
                      <ApiItem
                        apiItem={deleteFolderApiItem}
                        sites={sites}
                      ></ApiItem>
          ...
          >
            ...
            <div className="uppercase font-semibold text-base">Sites</div>
          </div>
          {sitesExpanded && (
            <div className="ml-2 mb-4 flex flex-cols">
              <div className="w-4 border-l"></div>
          ...
          >
            ...
            <div className="uppercase font-semibold text-base">Tag Schemas</div>
          </div>
          {tagSchemasExpanded && (
            <div className="ml-2 mb-4 flex flex-cols">
              <div className="w-4 border-l"></div>
              <div className="grow">
                ...
                <ApiItem
                  apiItem={postTagSchemasApiItem}
                  sites={sites}
                ></ApiItem>
                <ApiItem apiItem={getTagSchemaApiItem} sites={sites}></ApiItem>
                <ApiItem
                  apiItem={deleteTagSchemaApiItem}
                  sites={sites}
                ></ApiItem>
              </div>
            </div>
          ...
          >
            ...
            <div className="uppercase font-semibold text-base">Webhooks</div>
          </div>
          {webhooksExpanded && (
            <div className="ml-2 mb-4 flex flex-cols">
              <div className="w-4 border-l"></div>
              <div className="grow">
                ...
                <ApiItem
                  apiItem={getWebhookTagsApiItem}
                  sites={sites}
                ></ApiItem>
                <ApiItem
                  apiItem={postWebhookTagsApiItem}
                  sites={sites}
                ></ApiItem>
                <ApiItem
                  apiItem={postPrivateWebhooksApiItem}
                  sites={sites}
                ></ApiItem>
                <div
                  className="w-full flex self-start text-gray-400 hover:text-gray-500 justify-center lg:justify-start whitespace-nowrap pb-2 cursor-pointer"
          ...
          >
            ...
            <div className="uppercase font-semibold text-base">Version</div>
          </div>
          {versionExpanded && (
            <div className="ml-2 mb-4 flex flex-cols">
              <div className="w-4 border-l"></div>
