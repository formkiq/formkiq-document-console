...
function EventBridge({newStep, setNewStep, isEditing, data, edges, id, addCreatorNode, onChange, readOnly}: any) {
  ...
  return (
    <>
      ...
      <TextInput
        ...
        selectedValue={isEditing ? (newStep?.parameters?.eventBusName) : data.parameters?.eventBusName}
        isEditing={isEditing}/>
