...
import AddAttributeForm from "./AddPolicyAttributeForm";
import {DataCacheState} from "../../Store/reducers/data";

function AddPolicyAttributeForm({onDocumentDataChange, siteId, value, getValue}: any) {
...
export default AddPolicyAttributeForm;
