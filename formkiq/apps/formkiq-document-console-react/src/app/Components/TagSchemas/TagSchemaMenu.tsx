...
function CaseMenu({tagSchema, updateTagSchema, deleteTagSchema}: CaseMenuPropsType) {
    ...
    <>
      <div className="flex justify-between">
        <div className="flex gap-2 items-center">
          {isNameSelected ? <div className="flex gap-2 items-center">
              <input
            ...
            <div className="flex gap-2 items-center">
              <h2 className="text-2xl font-bold text-neutral-900 ">{tagSchema.name}</h2>
        ...
        <div className="flex gap-2">
          <button className="h-6 text-gray-900 hover:text-coreOrange-500" title="Delete Tag Schema" type="button"
                  onClick={deleteTagSchema}><Trash/>
          </button>
          <NavLink className="h-7 text-gray-900 hover:text-coreOrange-500" title="Open in Editor" to="?editor=true"><Pencil/>
          </NavLink>
        </div>

      </div>
      <p className="text-neutral-700 text-sm mt-2">
        Allow Additional Tags: <span
        className="font-bold text-neutral-900">{tagSchema.tags.allowAdditionalTags ? "Yes" : "No"}</span>
      </p>
