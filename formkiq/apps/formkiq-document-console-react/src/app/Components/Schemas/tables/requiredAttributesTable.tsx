type RequiredAttributesTableProps = {
  attributes?: {
    attributeKey: string;
    defaultValue?: string;
...
function RequiredAttributesTable({attributes}: RequiredAttributesTableProps) {
  return (
    <table
    ...
    >
      ...
      <tr>
        ...
        <th
          className=" w-full  border-b border-t p-4 py-3 bg-clip-text bg-gradient-to-l from-primary-500 via-secondary-500 to-primary-600">Default
          Values
        </th>
        <th
      ...
      {(attributes&&attributes.length > 0) ? attributes.map((attribute, index) => (
          <tr key={"attribute_" + attribute.attributeKey} className="text-neutral-900 border-neutral-300 text-left">
            ...
            <td className="border-b p-4">
              {attribute.defaultValues && attribute.defaultValues.join(', ')}
        ...
        <tr className="text-neutral-900 border-neutral-300">
          <td colSpan={4} className=" text-center border-b p-4">
...
export default RequiredAttributesTable;
