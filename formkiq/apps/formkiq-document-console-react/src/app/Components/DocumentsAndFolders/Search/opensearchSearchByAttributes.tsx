      ...
      <div className="h-8 gap-2 flex items-center">
        ...
        }
        {
          ...
          <div className="flex items-center gap-2 h-full">
            <RadioListbox values={['true', 'false']} titles={['True', 'False']}
...

        {
          selectedAttribute && selectedAttribute.dataType === "BOOLEAN" &&
          selectedAttributeCriteria === "eqOr" &&
          <CheckboxListbox values={['true', 'false']} selectedValues={attributeValues}
          ...
          {selectedAttributesQuery.map((item: any, i: number) => (
            <tr key={i} className="border-t border-neutral-300">
              ...
              <td className="px-2">
                ...
                {item.eqOr && item.eqOr.filter((val: any) => val.booleanValue !== undefined).map((val: any) => val.booleanValue).join(", ")}
              </td>
              <td>
