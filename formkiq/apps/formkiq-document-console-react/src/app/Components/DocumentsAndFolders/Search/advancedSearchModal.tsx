...
export default function AdvancedSearchModal({isOpened, onClose, siteId}: {isOpened: boolean, onClose: any, siteId: string}) {
                      ...
                      <div className="bg-white p-4 rounded-lg bg-white shadow-xl border h-full">
                        ...
                        <div className="flex flext-wrap mt-4">
                          <form
                            ...
                            <div className="mx-4">
                              <input type="submit" value="Search" className="bg-coreOrange-500 hover:bg-coreOrange-600 text-white font-semibold py-2 px-4 rounded mr-2" />
