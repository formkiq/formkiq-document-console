...
function AddAttributesTab({
  ...
  useEffect(() => {
    ...
    const selectedAttribute = allAttributes.find(a => a.key === attribute.attributeKey);
    ...
    <>
      <div className="flex flex-row items-center gap-4 text-base h-10">
        <RadioCombobox
          ...
          setSelectedValue={(attributeKey) => setAttribute((prev:any) => ({ ...prev, attributeKey }))}
          placeholderText="Key"
        />
          ...
          <div className="flex flex-row justify-between items-center gap-4 text-base">
            {dataType === 'STRING' && (
              <input
                ...
                onChange={(e) => setAttribute((prev:any) => ({ ...prev, defaultValue: e.target.value }))}
            ...
            {dataType === 'BOOLEAN' && (
              <div className="mt-2 flex items-center gap-2">
                <input
                  ...
                  onChange={(e) => setAttribute((prev:any) => ({ ...prev, defaultValue: e.target.checked ? 'true' : 'false' }))}
                />
        ...
        <>
          <div className="h-10">
            <RadioListbox
              ...
              setSelectedValue={(sourceType) => setAttribute((prev:any) => ({ ...prev, sourceType: sourceType as MappingAttributeSourceType }))}
          ...
          <div className="h-10">
            <RadioListbox
              ...
              setSelectedValue={(labelMatchingType) => setAttribute((prev:any) => ({ ...prev, labelMatchingType: labelMatchingType as MappingAttributeLabelMatchingType }))}
          ...
          <div className="flex flex-row justify-between items-center gap-4 text-base">
            <input
              ...
              onChange={(e) => setAttribute((prev:any) => ({ ...prev, labelText: e.target.value }))}
              onKeyDown={preventDialogClose}
            />
            <button
              type="button"
