...
type MappingAttributeSourceType = 'CONTENT' | 'CONTENT_KEY_VALUE' | 'METADATA';
type MappingAttributeLabelMatchingType =
  | ' FUZZY'
  | 'EXACT'
  | 'BEGINS_WITH'
  | 'CONTAINS';
type MappingAttributeMetadataField = 'USERNAME' | 'PATH' | 'CONTENT_TYPE';
